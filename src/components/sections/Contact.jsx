  ...
  return (
    <section className="contact section">
      <div className="container">
        <h2 className="section-title reveal-bottom">Let's Build Something Useful</h2>
        <p className="section-subtitle reveal-bottom">Open to opportunities where I can contribute to real-world products and continue growing as a Full Stack Developer.</p>

        <div className="contact-grid">
          {/* Contact Info */}
          <div className="contact-info reveal-left">
            <h3>Get In Touch</h3>
            <p>I'm always interested in hearing about new projects and collaboration opportunities. Feel free to reach out via email, phone, or the form.</p>
            ...
            <div className="contact-social">
              ...
              <div className="social-icons">
                ...
                <a href={portfolioData.personal.social.instagram} target="_blank" rel="noopener noreferrer" className="social-link">
                  <svg viewBox="0 0 24 24" fill="currentColor">
